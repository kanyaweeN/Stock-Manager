/**
 * คำนวณยอดสำหรับหน้า `/summary` — คำนวณล้วนๆ ไม่มี state (เทียบเคียง lib/domain/cost.ts, lib/domain/plan.ts)
 *
 ...
 */
import { monthISO, thaiMonthLabel } from "@/lib/core/date";
import { normalizeShopName, shopKey, type OrderExtra } from "@/lib/domain/orders";
import { priceStats, roundBaht } from "@/lib/domain/price";
import { remainingUnits } from "@/lib/domain/stock";
