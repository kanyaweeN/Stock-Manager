import { endOfMonthISO, monthISO, thaiMonthLabel } from "@/lib/core/date";
import type { PlanLine, PlanPriority, PurchasePlan, StockItem } from "@/lib/types";
import { isFrequent } from "@/lib/domain/price";
import { isLow, isOutOfStock } from "@/lib/domain/stock";
import { daysUntilEmpty, runningOut } from "@/lib/domain/usage";
 ...
 * (นับจากประวัติราคาให้อัตโนมัติ ไม่ได้ติดธงเอง — ดู isFrequent ใน lib/domain/price.ts)
 */
