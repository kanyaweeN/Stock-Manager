 ...
 * (เทียบเคียง lib/domain/price.ts, lib/domain/expiry.ts)
 *
 ...
 */
import { daysBetween, todayISO } from "@/lib/core/date";
import { isOutOfStock, remainingUnits } from "@/lib/domain/stock";
import type { StockItem, UsagePoint } from "@/lib/types";
