 ...
 *
 * ตัวแกะหน้าออเดอร์มี **สองแบบเท่านั้น** (ดู `lib/orderPage.ts`):
 * Shopee ใช้ตัวแกะเฉพาะของมัน (`lib/shopee.ts` — อาศัยโครง `<a>` ที่ครอบรูป+ชื่อ)
 ...
 */
import type { SellerHints, ShopLookup } from "./importDom";
import type { ChargeLabels, DateFormat } from "./importText";
 ...
 * แล้วส่งต่อให้ตัวแกะของร้านนั้น (ดู `lib/orderPage.ts`)
 */
