 ...
 * ไม่มี DOM ไม่มี state — ส่วนที่ต้องเดินโครงสร้างหน้าเว็บอยู่ที่ `lib/import/dom.ts`
 *
 * แยกออกมาเพราะเดิมทั้งหมดนี้อยู่ใน `lib/import/shopee.ts` ที่เทสต์ไม่ได้ (ทั้งไฟล์ต้องใช้ `DOMParser`)
