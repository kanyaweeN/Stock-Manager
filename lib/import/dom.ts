 ...
 *
 * แยกจาก `lib/import/text.ts` (ข้อความล้วน เทสต์ได้) เพราะไฟล์นี้ต้องมี DOM จริง —
 * ตั้งใจไม่ลง jsdom เพิ่ม พิสูจน์ด้วยการวาง HTML จริงในกล่องนำเข้าคุ้มกว่า
 */
import { isLabelOnly, parsePriceLeaf, parseQtyLeaf } from "@/lib/import/text";
 ...
 * ส่วนร้านอื่นใช้ "ต้องมีราคา" (ดูเหตุผลใน `lib/import/orderPage.ts`)
 */
